...
static void csv_start_part_td(rlib *r, struct rlib_part *part) {}
...
static void csv_graph_plot_line(rlib *r, gchar side, gint iteration, gfloat p1_height, gfloat p1_last_height, gfloat p2_height, gfloat p2_last_height, struct rlib_rgb * color, gint row_count) {}
